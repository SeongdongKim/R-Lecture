...
legend(4,10,c("v1","v2","v3"), cex=0.9, col=c("red","blue", "green"), lty=1)
...
height <- c(182, 172, 167, 172, 163, 178, 181, 166, 159, 155)
par(mfrow=c(1,2))
...
legend(0.82, 1.08, c("Week 1", "Week 2", "Week 3", "Week 4"), cex=0.5, fill=rainbow(length(p1)))
...
legend(0.78, 1.14, c("MON", "TUE", "WED", "THU", "FRI"), cex=0.6, fill=rainbow(length(p1)))
